...
from proyecto_demeter.shared.schemas import GpioCommand, PingCommand, SequenceCommand, SequenceStep, ActionResponse
...
async def test_service_sequence_command():
    ...
    # Simulate processing
    from proyecto_demeter.shared.schemas import ExecSequence
