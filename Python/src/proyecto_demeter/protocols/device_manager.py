...
class DeviceManager:
    ...
    def __init__(self, config_path=None):
        ...
        if config_path is None:
            # Resolve relative to this file: ../../../../config/inventory.json
            base_dir = os.path.dirname(os.path.abspath(__file__))
            # protocols -> proyecto_demeter -> src -> python -> config
            self.config_path = os.path.join(base_dir, "..", "..", "..", "config", "inventory.json")
