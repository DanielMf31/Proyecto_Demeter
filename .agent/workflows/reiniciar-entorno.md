...
3. Esperamos a que la base de datos esté lista e inyectamos el histórico base de 6 meses (seeder).
```bash
sleep 5 && docker compose exec -e PYTHONPATH=/app/Software/Servidor/Backend:/app/Software/Common api python -m BD.seed_data
```
