...
void run_integration_tests() {
    RUN_TEST(test_uart_integration);
    RUN_TEST(test_esp_now_integration);
    RUN_TEST(test_full_system_lifecycle);
    RUN_TEST(test_actuator_flow);
    RUN_TEST(test_nack_behavior);
}
